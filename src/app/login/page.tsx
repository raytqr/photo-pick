            ...
            >
                <div className="glass rounded-[32px] sm:rounded-[40px] p-6 sm:p-8 lg:p-12 border-white/5 shadow-2xl">
                    ...
                    <div className="text-center space-y-4 mb-8 sm:mb-10">
                        <Link href="/" className="inline-flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-gradient-to-tr from-purple-600 to-pink-600 shadow-xl shadow-purple-500/20 mb-4 sm:mb-6 group transition-transform hover:scale-110">
